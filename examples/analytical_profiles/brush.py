...
TODO: remove brushGauss.py from Git
"""
...
class Brush(AnalyticalReflectivityFunction):
    ...
    def vfp_area(self, params):
        ...
        #Evaluates volume fraction profile then calculates area using Simpson's
        #Rule
        points, profile = self.vol_fraction(params)
...
class BrushPara(Brush):
    ...
    def to_slab(self, params):
        ...
        #Lambda function for determine SLD for a given polymer volume fraction
        ...
        for i in range(self.n_slices):
            ...
            phi = lmfit_values['phi_init'] *  (1 - (distance / lmfit_values['thickness_tail'])**2)
